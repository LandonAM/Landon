...
export function getScale(container, options) {
...
export function setScale(container, value, options) {
    if (options === void 0) { options = {}; }
...
export function resetScale(container, options) {
    setScale(container, 1, options);
}
export function zoom(container, ratio, options) {
